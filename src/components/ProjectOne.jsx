...
const ProjectOne = ({header, stackone, stackthree, stacktwo,  explanation, projectimage}) => {
  return (
        ...
        <div className="flex flex-row justify-center my-[15px] ">
          <div className="mx-[10px]">
            <div className="border-[1px] px-[20px] py-[5px] md:py-[10px] rounded-[5px] border-light-black flex justify-between items-center">
              <a href="https://adesina-abiodun.github.io/RGB-Color-Game/colorgame/colorgame.html" className="text-center text-[14px] md:text-[17px]">Visit website</a>
          ...
          <div className="mx-[10px]">
              <div className="border-[1px] px-[20px] py-[5px] md:py-[10px] rounded-[5px] border-light-black flex justify-between items-center">
                <a href="https://github.com/Adesina-Abiodun/RGB-Color-Game" className="text-center text-[14px] md:text-[17px]">View code</a>
