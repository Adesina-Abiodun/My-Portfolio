...
const ProjectThree = ({header, stackone, stackthree, stacktwo, stackfour, explanation, projectimage}) => {
  return (
   <div className="flex flex-col-reverse xl:flex-row justify-center items-center my-[40px]">
      <div className="flex flex-col items-center mx-[10px] flex-[100%] max-w-full" >
...
<div className="mx-[10px]">
  <div className="border-[1px] px-[20px] py-[5px] md:py-[10px] rounded-[5px] border-light-black flex justify-between items-center">
    <a href="https://cutt.ly/v25A6rp" className="text-center text-[14px] md:text-[17px]">Visit website</a>
...
<div className="mx-[10px]">
  <div className="border-[1px] px-[20px] py-[5px] md:py-[10px] rounded-[5px] border-light-black flex justify-between items-center">
  <a href="https://github.com/Adesina-Abiodun/Pizza-website" className="text-center text-[14px] md:text-[17px]">View code</a>
  <img src={github} alt="Github icon" className="fill-black mx-[3px] w-[20px] h-[20px] md:w-[25px] md:h-[25px]" />
      ...
      <div className="m-[10px] flex justify-center flex-[100%] max-w-full" >
        <img src={projectimage} alt="Weather website landing page" className="w-[300px] md:w-[500px] h-[100%] rounded-[5px]" />
      </div>
    </div>
  )
}
