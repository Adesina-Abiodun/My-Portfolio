        ...
        <div className="flex flex-col-reverse xl:flex-row-reverse items-center justify-center">
            <div className="flex flex-col items-center m-[10px] flex-[100%] max-w-full" >
              ...
              <div className="flex my-[5px]">
                {/* <img src={stackone} alt="HTML logo" className="w-[10px] h-[10px] md:w-[40px] md:h-[40px] mx-1" /> */}
              </div>
              ...
              <div className="flex flex-row justify-center my-[15px] ">
                <div className="border-[1px] px-[20px] py-[5px] md:py-[10px] rounded-[5px] border-light-black flex justify-between items-center">
                  <a href="https://adesinaabiodunpaul.medium.com/" className="text-center text-[14px] md:text-[17px]">View articles</a>
                  <div className="mx-[3px]"> 
                    <svg className="w-[20px] h-[15px] md:w-[25px] md:h-[25px]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" >
